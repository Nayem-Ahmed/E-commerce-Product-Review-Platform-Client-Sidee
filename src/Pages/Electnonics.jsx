...
const Electnonics = () => {
    ...
    const [categoryFilter, setCategoryFilter] = useState('electronics'); // Default category filter set to 'electronics'
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setElectronicsProducts(productsData);
            } catch (error) {
    ...
    const currentItems = electronicsProducts.slice(indexOfFirstItem, indexOfLastItem);

    // Calculate the total number of pages
    const totalPages = Math.ceil(electronicsProducts.length / itemsPerPage);
